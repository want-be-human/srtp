...
HOTSPOTS = [
    {"sid": "2024112434", "cx": 0.30, "cy": 0.48, "scatter": 0.06, "count": (1, 2), "note": "陈思远 · 起弧端 + 上沿"},
    {"sid": "2024111216", "cx": 0.55, "cy": 0.52, "scatter": 0.12, "count": (2, 3), "note": "王俊杰 · 中段散布、缺陷多"},
    {"sid": "2024112605", "cx": 0.50, "cy": 0.50, "scatter": 0.05, "count": (1, 1), "note": "林雨晴 · 中线集中、稳定"},
    {"sid": "2024110853", "cx": 0.50, "cy": 0.50, "scatter": 0.04, "count": (0, 1), "note": "赵嘉宁 · 极少出错"},
    {"sid": "2024113182", "cx": 0.40, "cy": 0.62, "scatter": 0.07, "count": (1, 2), "note": "黄子睿 · 下沿光滑度差"},
    {"sid": "2024110741", "cx": 0.72, "cy": 0.50, "scatter": 0.08, "count": (1, 3), "note": "周文静 · 收弧端起伏大"},
]
